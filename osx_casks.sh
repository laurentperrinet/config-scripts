...
brew cask uninstall --force evernote macvim openoffice inkscape filezilla cakebrew  todotxt tunnelblick  tomahawk  adobe-reader clamxav  dropbox thunderbird  unison pineapple arduino zotero flash-player wireshark
