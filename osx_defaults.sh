...
# forked from ~/.osx — http://mths.be/osx - https://raw.githubusercontent.com/mathiasbynens/dotfiles/master/.macos
# to merge, use ```opendiff /tmp/.macos osx_defaults.sh```
...
# defaults delete NSGlobalDomain com.apple.swipescrolldirection -bool false

# Increase sound quality for Bluetooth headphones/headsets
# defaults delete com.apple.BluetoothAudioAgent
